...
struct WebhookService {
    ...
    static func verifySignature(of request: URLRequest,
                                using options: SockudoClientOptions) throws {
        ...
        guard let xSockudoKeyHeaderValue = request.value(forHTTPHeaderField: xSockudoKeyHeader),
              xSockudoKeyHeaderValue == options.key else {
        ...
        guard let xSockudoSignatureHeaderValue = request.value(forHTTPHeaderField: xSockudoSignatureHeader),
              expectedSignature == xSockudoSignatureHeaderValue else {
    ...
    static func webhook(from request: URLRequest, using options: SockudoClientOptions) throws -> Webhook {
